...
constexpr EndpointId ifxLightDimmerSwitchEndpointId = 1;
...
void ChipEventHandler(const chip::DeviceLayer::ChipDeviceEvent *, intptr_t);
#endif
...
APPLICATION_START()
{
    ...
    LightSwitch::GetInstance().Init(ifxLightDimmerSwitchEndpointId);
...
/* To identify the connection status */
